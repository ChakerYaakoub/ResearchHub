import { facilitiesPage } from './strings'
    ...
    <>
      <header className="page-header py-4">
        <div className="container">
          <h1 className="page-title h2 mb-2">{facilitiesPage.title}</h1>
          <p className="text-muted mb-0 col-lg-8 px-0">{facilitiesPage.intro}</p>
        </div>
      </header>
